...
class Fitness_Impact_Pop_Callback(Fitness_Impact_Inds_Callback):
    ...
    def notify(self, algorithm):
        ...
        for i in range(0, len(population)):
            if self.tracing_type == TracingTypes.NO_TRACING:
                ...
                current_ind_fitness_impact = self.print_traceVector_fitness_impact(population[i], worst_fitness)
